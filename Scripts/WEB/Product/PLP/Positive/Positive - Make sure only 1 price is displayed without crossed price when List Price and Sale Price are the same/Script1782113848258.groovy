...
//====================================================
// VERIFY NON PROMOTIONAL PRODUCT
//====================================================
WebUI.verifyElementPresent(findTestObject('WEB/Product/PLP/Product/card_NonPromoProduct'), 10)

//====================================================
// OPEN PRODUCT DETAIL
//====================================================
WebUI.verifyElementVisible(findTestObject('WEB/Product/PLP/Product/card_NonPromoProduct'))

WebUI.delay(5)

WebUI.waitForPageLoad(10)

WebUI.executeJavaScript('window.open(\'https://portal-test.gtech.asia/login\')', null)

WebUI.switchToWindowIndex(1)

WebUI.waitForPageLoad(20)

WebUI.setText(findTestObject('WEB/Titan/Login/txt_Username'), GlobalVariable.TitanUsername)

WebUI.setEncryptedText(findTestObject('WEB/Titan/Login/txt_Password'), GlobalVariable.TitanPassword)

WebUI.setText(findTestObject('WEB/Titan/Login/txt_Captcha'), GlobalVariable.TitanCaptcha)

WebUI.click(findTestObject('WEB/Titan/Login/btn_Login'))
