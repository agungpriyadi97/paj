...
WebUI.click(findTestObject('WEB/Checkout/Address Checkout/Shipping Address/Delete Shipping Address/btn_DeleteAddress'))
...
// CONFIRM DELETE
//====================================================
WebUI.verifyElementVisible(findTestObject('WEB/Address/Billing Address/Delete Billing Address/popup_DeleteConfirmation'))
