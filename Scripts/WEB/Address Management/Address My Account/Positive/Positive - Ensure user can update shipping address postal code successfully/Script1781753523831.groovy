...
// GET OLD POSTAL CODE
//====================================================
String oldPostalCode = WebUI.getAttribute(findTestObject('WEB/Address/Shipping Address/Edit Address/txt_PostalCode'), 'value')

println('OLD POSTAL CODE : ' + oldPostalCode)

//====================================================
// UPDATE POSTAL CODE
//====================================================
String newPostalCode = '15811'

if (oldPostalCode == '15811') {
    newPostalCode = '15810'
}

WebUI.clearText(findTestObject('WEB/Address/Shipping Address/Edit Address/txt_PostalCode'))

WebUI.setText(findTestObject('WEB/Address/Shipping Address/Edit Address/txt_PostalCode'), newPostalCode)

println('NEW POSTAL CODE : ' + newPostalCode)
