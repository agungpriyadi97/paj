...
// PROVINCE
//====================================================
WebUI.click(findTestObject('WEB/Address/Shipping Address/Add New Shipping Address/ddl_Province'))
...
// CITY
//====================================================
WebUI.click(findTestObject('WEB/Address/Shipping Address/Add New Shipping Address/ddl_City'))
...
// DISTRICT
//====================================================
WebUI.click(findTestObject('WEB/Address/Shipping Address/Add New Shipping Address/ddl_District'))
...
// SAVE
//====================================================
WebUI.scrollToElement(findTestObject('WEB/Address/Shipping Address/Add New Shipping Address/btn_Save'), 10)

WebUI.enhancedClick(findTestObject('WEB/Address/Shipping Address/Add New Shipping Address/btn_Save'))
