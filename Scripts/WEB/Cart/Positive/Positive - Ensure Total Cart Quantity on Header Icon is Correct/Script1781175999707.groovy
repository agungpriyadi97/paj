...
// GET HEADER CART QTY
//====================================================
String headerQtyText = WebUI.getText(
	findTestObject('WEB/Home/Header/Icon Menu/lbl_CartBadge')
).trim()

println('HEADER CART QTY : ' + headerQtyText)

int headerQty = Integer.parseInt(headerQtyText)
...
// GET CART QTY
//====================================================
String cartQtyText = WebUI.getAttribute(
	findTestObject('WEB/Cart/txt_QuantityValue'),
	'value'
)

println('CART QTY : ' + cartQtyText)

int cartQty = Integer.parseInt(cartQtyText)

//====================================================
// VERIFY HEADER QTY = CART QTY
//====================================================
assert headerQty == cartQty

println('HEADER CART QUANTITY VERIFIED')

//====================================================
// TEST PASSED
//====================================================
println('TOTAL CART QUANTITY ON HEADER ICON IS CORRECT')