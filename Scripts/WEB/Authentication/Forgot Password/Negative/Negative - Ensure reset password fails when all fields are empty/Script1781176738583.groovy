...
//====================================================
WebUI.setText(findTestObject('WEB/Authentication/ForgotPassword/txt_Email'), '')

WebUI.setText(findTestObject('WEB/Authentication/ForgotPassword/txt_ValidationCode'), '')

WebUI.setText(findTestObject('WEB/Authentication/ForgotPassword/txt_Password'), '')

WebUI.setText(findTestObject('WEB/Authentication/ForgotPassword/txt_ConfirmPassword'), '')
...
// VERIFY VALIDATION
//====================================================
WebUI.verifyElementVisible(findTestObject('WEB/Authentication/ForgotPassword/error_PasswordRequired'), FailureHandling.STOP_ON_FAILURE)

println('RESET PASSWORD FAILED - ALL FIELDS EMPTY')
