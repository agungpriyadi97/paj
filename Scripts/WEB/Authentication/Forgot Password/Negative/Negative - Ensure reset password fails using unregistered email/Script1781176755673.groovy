...
//====================================================
// GENERATE UNREGISTERED EMAIL
//====================================================
String email = ('unregistered' + System.currentTimeMillis()) + '@mailinator.com'
...
//====================================================
WebUI.verifyElementVisible(findTestObject('WEB/Authentication/ForgotPassword/lbl_Toast_AccountOrEmailNotExist'), FailureHandling.STOP_ON_FAILURE)

println('UNREGISTERED EMAIL VALIDATION DISPLAYED')
