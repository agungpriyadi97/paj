...
// INPUT INVALID OTP
//====================================================
WebUI.setText(findTestObject('WEB/Authentication/ForgotPassword/txt_ValidationCode'), '999999')
...
// VERIFY ERROR
//====================================================
WebUI.verifyElementVisible(findTestObject('WEB/Authentication/ForgotPassword/msg_invalid_code'), FailureHandling.STOP_ON_FAILURE)

println('INVALID VALIDATION CODE VERIFIED')
