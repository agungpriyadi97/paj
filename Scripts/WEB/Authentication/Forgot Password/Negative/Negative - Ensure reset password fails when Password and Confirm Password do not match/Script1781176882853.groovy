...
//====================================================
WebUI.setText(findTestObject('WEB/Authentication/ForgotPassword/txt_Password'), 'Laskar123456@')

WebUI.setText(findTestObject('WEB/Authentication/ForgotPassword/txt_ConfirmPassword'), 'Laskar123456#')
...
//====================================================
WebUI.verifyElementVisible(findTestObject('WEB/Authentication/ForgotPassword/msg_PasswordMismatch'), FailureHandling.STOP_ON_FAILURE)

println('PASSWORD MISMATCH VERIFIED')
