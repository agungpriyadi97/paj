...
WebUI.takeScreenshot(RunConfiguration.getReportFolder() + '/TC_Login_IncorrectPassword.png')

KeywordUtil.markPassed('Validasi berhasil: Login gagal menggunakan password yang salah')
