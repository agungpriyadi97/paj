...
WebUI.comment('=== TC_Login_IncorrectPassword: Login gagal menggunakan password yang salah ===')
...
WebUI.setText(findTestObject('WEB/Authentication/Login/txt_Email'), 'agungrrrr@gmail.com')

// 2. Isi field Password dengan nilai yang salah (tidak sesuai)
WebUI.setText(findTestObject('WEB/Authentication/Login/txt_Password'), 'wrongPassword123')

// 3. Klik tombol Sign In
WebUI.click(findTestObject('WEB/Authentication/Login/btn_sign_in'))

// 4. Verifikasi login GAGAL:
//    - Muncul pesan error lbl_LoginFailed (sesuai Object Repository)
//    - Tombol Sign In masih ada (tidak redirect ke halaman sukses)
WebUI.waitForElementVisible(findTestObject('WEB/Authentication/Login/msg_invalid_login'), 5)

// Verifikasi tambahan: halaman masih menampilkan tombol Sign In
