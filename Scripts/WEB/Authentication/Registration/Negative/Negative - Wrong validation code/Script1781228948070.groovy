...
WebUI.setText(findTestObject('WEB/Authentication/Registration/verificationCodeInput'), wrongOTP)
...
WebUI.verifyElementVisible(findTestObject('WEB/Authentication/Registration/errorMassageVerificationCodeInvalid'))
