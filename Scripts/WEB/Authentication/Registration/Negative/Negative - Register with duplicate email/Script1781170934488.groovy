...
WebUI.setText(findTestObject('WEB/Authentication/Registration/emailInput'), GlobalVariable.ForgotPasswordEmail)

WebUI.click(findTestObject('WEB/Authentication/Registration/getCodeButton'))

WebUI.verifyElementVisible(findTestObject('WEB/Authentication/Registration/massage_duplicate_email'), FailureHandling.STOP_ON_FAILURE)
