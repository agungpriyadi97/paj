...
WebUI.setText(findTestObject('WEB/Authentication/Registration/passwordInput'), 'Laskar123456@')

WebUI.setText(findTestObject('WEB/Authentication/Registration/mobileInput'), '123')
...
WebUI.verifyElementVisible(findTestObject('WEB/Authentication/Registration/errorMessageMobile'))
