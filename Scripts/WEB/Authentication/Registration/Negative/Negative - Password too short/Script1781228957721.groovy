...
WebUI.setText(findTestObject('WEB/Authentication/Registration/passwordInput'), '123')
...
WebUI.verifyElementVisible(findTestObject('WEB/Authentication/Registration/errorMessagePassword'))
