...
WebUI.verifyElementText(
	findTestObject('WEB/Product/PLP/Filter/lbl_Brand'),
	'Brand'
)

WebUI.verifyElementText(
	findTestObject('WEB/Product/PLP/Filter/lbl_Collection'),
	'Collection'
)

WebUI.verifyElementText(
	findTestObject('WEB/Product/PLP/Filter/lbl_Size'),
	'Size'
)

WebUI.verifyElementText(
	findTestObject('WEB/Product/PLP/Filter/lbl_Color'),
	'Color'
)

WebUI.verifyElementText(
	findTestObject('WEB/Product/PLP/Filter/lbl_Price'),
	'Price'
)

WebUI.verifyElementText(
	findTestObject('WEB/Product/PLP/Filter/lbl_SortBy'),
	'Sort By'
)

println('PLP FILTER COPYWRITING VERIFIED')