...
WebUI.verifyElementVisible(findTestObject('WEB/Checkout/Address Checkout/Billing Address/Add New Billing Address/lbl_BillingAddressSameAsShipping'))

WebUI.verifyElementText(findTestObject('WEB/Checkout/Address Checkout/Billing Address/Add New Billing Address/lbl_BillingAddressSameAsShipping'), 
