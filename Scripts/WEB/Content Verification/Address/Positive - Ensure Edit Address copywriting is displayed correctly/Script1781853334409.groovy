...
WebUI.verifyElementVisible(findTestObject('WEB/Checkout/Address Checkout/Billing Address/Edit Shipping Address/btn_EditAddress'))

WebUI.verifyElementText(findTestObject('WEB/Checkout/Address Checkout/Billing Address/Edit Shipping Address/btn_EditAddress'), 
    'Edit')
